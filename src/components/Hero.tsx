...
const skills = [
	{
		...
		description: "Expert in building sites with modern technologies.",
	},
	{
		title: "Future-oriented",
		description: "Always looking ahead to the future.",
	},
	{
	...
	{
		title: "Love to build things",
		description: "Passionate about creating new projects.",
	},
];
	...
	return (
		<div className="pb-20 pt-36 lg:pb-5 lg:pt-5 min-h-screen max-h-screen relative z-10">
			...
			<div className="flex items-center justify-center min-h-screen relative">
				<div className="relative z-20 flex flex-col lg:flex-row items-center justify-between w-full px-4 lg:px-10">
					<div className="flex flex-col items-center lg:items-start lg:text-left lg:w-1/2 space-y-4">
						...
						<p className="text-center lg:text-left md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
							Hey, I&apos;m Aaron, a software engineer <br /> based in Germany,
